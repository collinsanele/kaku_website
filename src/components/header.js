        ...
        <div class=" mx-auto py-3 md:flex md:justify-between md:items-center relative">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex md:hidden">
                    <button type="button" class="text-black hover:text-gray-900 focus:outline-none focus:text-gray-900 z-50" aria-label="toggle menu" onClick={() => setMenuOpen(!menuOpen)}>
                        <Hamburger size={32}/>
                    </button>
                </div>
            ...
            {/* drop-down menu */}
            <div className={ " flex justify-center absolute inset-0 top-0 right-0 w-full h-screen bgcolor items-center transition transform duration-500 ease-in-out z-30 " +
