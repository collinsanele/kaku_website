        ...
        <section className="w-11/12 lg:w-8/12 mx-auto">
          <div className="py-24">
            <div className="flex flex-col sm:flex-row sm:items-center items-start mx-auto">
              ...
              <button
                className="h-16 transition transform duration-1000 ease-in-out hover:-translate-y-1 hover:scale-110 border border-green-500 flex-shrink-0 text-gray-200 border-0 py-2 px-8 focus:outline-none bg-black rounded text-lg mt-10 sm:mt-0"
                style={{
            ...
            <div className="flex flex-col lg:flex-row py-16">
              ...
              <div className="lg:w-3/4 pt-10 lg:pt-0 leading-loose text-xl">
                <p className="mb-0" data-aos={"fade-up"}>
                  ...
                  and short write-ups for just about everyone. Whether you are a
                  SaaS start-up or a manufacturing entity, we have got you
                  covered.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row py-16">
              ...
              <div className="lg:w-3/4 pt-10 lg:pt-0 leading-loose font-medium text-xl">
                <p className="mb-0" data-aos={"fade-up"}>
                  ...
                  primary motivation stems from the fact that every brand
                  deserves a voice, and the verdict out there today is that
                  quality content is the best way to raise awareness and engage
                  with your audience.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row py-16">
              ...
              >
                <p>
                  ...
                  NEVER cut corners. We guarantee that every piece that comes
                  from us is 100 percent original and plagiarism free.
                </p>
                <p className="mb-0">
                  In a bid to sustain quality delivery, we are always looking
                  for competent hands to join our small team, so if this feels
                  like you, send us a message today. We would love to hear from
                  you.
                </p>
              </div>
            </div>
