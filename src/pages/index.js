            ...
            <div className="items-center md:flex">
                <div className="w-full md:w-1/2">
                    <div className="max-w-lg">
                        <h1 className="text-2xl font-semibold text-purple-874 md:text-3xl">A One-Stop Solution To All Your Brands' Contents Needs</h1>
                        <p className="mt-4 text-gray-600 dark:text-gray-400">Brands need to stand out in today's digital space and we create
              ...
              to='/Pricing/'  ><button className="px-3 py-2 mt-8 text-sm font-medium text-white uppercase bg-purple-874 rounded-md hover:bg-purple-900 focus:outline-none focus:bg-purple-900">Check our prices</button> </Link>
                ...
                <div className="flex items-center justify-center w-full mt-6 md:mt-0 md:w-1/2">
                    <img className="w-full h-full max-w-2xl"  src={blogging} alt='blogging'/>
                </div>
            </div>
        </section>
