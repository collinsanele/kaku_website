          ...
          <div className='items-center md:flex'>
            <div className='w-full md:w-1/2'>
              <div className='max-w-lg mt-10 md:mt-0'>
                ...
                <Link to='/Pricing/'>
                  <button className='px-3 py-2 mt-8 text-sm font-medium text-white uppercase bg-gradient-to-r from-purple-874 via-purple-874 to-blue-600 rounded-md hover:from-black focus:outline-none focus:bg-black'>
                    Check our prices
                  </button>{' '}
                </Link>
              </div>
