                ...
                <div className="xl:w-1/3 md:w-3/4 bg-white rounded-lg flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-9" style={{boxShadow: "0 2px 30px 0 rgba(0,0,0,.63)"}} >
                  <h2 className="text-5xl font-black text-center pt-12">Let's write amazing stuff together.</h2>
                          <form onSubmit={handleOnSubmit} className="p-8">
                            ...
                            <button type="submit" disabled={serverState.submitting} className="text-center text-sm flex-shrink-0 text-white p-2 mt-8 focus:outline-none bg-black transition transform duration-500 ease-in-out hover:-translate-y-1 hover:scale-110 border border-green-500 font-bold rounded">
                              Send message
                            </button>
                            {serverState.status && (
